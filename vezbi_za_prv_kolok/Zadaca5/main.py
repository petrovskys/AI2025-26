...
class Pacman(Problem):
    ...
    def successor(self,state):
        ...
        for move,(nx,ny) in moves[facing].items():
            if (nx+x<0 or nx+x>9) or (ny+y<0 or ny+y>9):
                continue
            if (nx+x,ny+y) in self.walls and (nx+x,ny+y) in dots:
                pass
               #print("hello")
            if (nx+x,ny+y) in self.walls:
                continue

            if (nx+x,ny+y) in dots:
                ls=list(dots)
                ls.remove((nx+x,ny+y))
                #print("I found a dot with move "+move+" There are "+str(len(ls))+" more")
                succ[move]=(nx+x,ny+y),new_direction[facing][move],tuple(ls)
            else:
                succ[move]=(nx+x,ny+y),new_direction[facing][move],dots
        return succ
...
if __name__ == "__main__":
    walls = ((6, 0), (4, 1), (5, 1), (6, 1), (8, 1), (1, 2), (6, 2), (1, 3), (1, 4), (4, 5), (0, 6),
             (3, 6), (4, 6), (5, 6), (4, 7), (8, 7), (9, 7), (0, 8), (8, 8), (9, 8), (0, 9), (1, 9), (2, 9), (3, 9),
             (6, 9))
    x=int(input())
    y=int(input())
    facing=input()
    ...
    initial = (x,y),facing,dots
    pacman = Pacman(initial,walls)
